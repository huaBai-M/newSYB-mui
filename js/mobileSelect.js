...
(function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			...
			//按钮监听
			_this.cancelBtn.addEventListener('tap',function(){
				console.log(0)
				_this.hide();
		    });

		    _this.ensureBtn.addEventListener('tap',function(){
				_this.hide();
			    if(!_this.liHeight) {
			        _this.liHeight =  _this.mobileSelect.querySelector('li').offsetHeight;
			    }
		    ...
		    _this.trigger.addEventListener('tap',function(){
		    	_this.show();
		    });
		    _this.grayLayer.addEventListener('tap',function(){
				_this.hide();
		    });
		    _this.popUp.addEventListener('tap',function(){
